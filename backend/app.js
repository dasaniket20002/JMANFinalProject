...
mongoose.connect(`mongodb+srv://${process.env.MONGO_UID}:${process.env.MONGO_PASS}@cluster0.xc9x9f1.mongodb.net/${process.env.MONGO_DBNAME}?retryWrites=true&w=majority&appName=Cluster0`)
