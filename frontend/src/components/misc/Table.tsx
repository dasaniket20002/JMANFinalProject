...
const Table = ({
  ...
  return (
    <div
      className={twMerge(
        "w-full bg-gray-100 shadow-md rounded overflow-auto",
        className
      )}
    >
...
export const TableHeader = ({
  ...
  return (
    <th
      className={twMerge("py-4 text-xl font-semibold bg-gray-300", className)}
    >
      {children}
    </th>
  );
...
export const TableRow = ({
  ...
  return (
    <tr className={twMerge("text-center border-b border-gray-200", className)}>
      {children}
    </tr>
  );
};
